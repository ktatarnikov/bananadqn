...
class Agent:
    ...
    def step(self, state: Sequence[int], action: int, reward: float,
             next_state: Sequence[int], done: bool):
    ...
    def act(self, state: Sequence[int], eps: float = 0.):
...
class ReplayBuffer:
    ...
    def add(self, state, action, reward: float, next_state, done) -> Tuple:
